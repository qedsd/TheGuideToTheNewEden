...
namespace TheGuideToTheNewEden.UWP.Controls
{
    public sealed partial class SkillTree : UserControl
    {
        ...
        public static readonly DependencyProperty GetSkillGroupTree = DependencyProperty.Register
            (
            //name    要注册的依赖项对象的名称
            "SkillGroupTree",
            ...
            new PropertyMetadata(0, new PropertyChangedCallback(SetSkillGroupTree))
            );

        private static void SetSkillGroupTree(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        {
            get { return (SkillGroup)GetValue(GetSkillGroupTree); }

            set { SetValue(GetSkillGroupTree, value); }
        }
