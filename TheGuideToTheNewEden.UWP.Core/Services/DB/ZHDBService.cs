...
namespace TheGuideToTheNewEden.Core.Services.DB
{
    public static class ZHDBService
    {
        ...
        public static async Task<List<InvTypeBase>> TranInvTypesAsync(List<int> invTypeIds)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<InvTypeBase>().Where(p=> invTypeIds.Contains(p.TypeID)).ToList();
            });
        }
        public static async Task<InvTypeBase> TranInvTypeAsync(int invTypeId)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<InvTypeBase>().FirstAsync(p => invTypeId == p.TypeID);
        }
        ...
        public static async Task<List<InvGroupBase>> TranInvGroupsAsync(List<int> invTypeIds)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<InvGroupBase>().Where(p => invTypeIds.Contains(p.GroupID)).ToList();
            });
        }
        public static async Task<InvGroupBase> TranInvGroupAsync(int invTypeId)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<InvGroupBase>().FirstAsync(p => invTypeId == p.GroupID);
        }
        ...
        public static async Task<List<MapRegionBase>> TranMapRegionsAsync(List<int> ids)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<MapRegionBase>().Where(p => ids.Contains(p.RegionID)).ToList();
            });
        }
        public static async Task<MapRegionBase> TranMapRegionAsync(int id)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<MapRegionBase>().FirstAsync(p => id == p.RegionID);
        }
        ...
        public static async Task<List<MapSolarSystemBase>> TranMapSolarSystemsAsync(List<int> ids)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<MapSolarSystemBase>().Where(p => ids.Contains(p.SolarSystemID)).ToList();
            });
        }
        public static async Task<MapSolarSystemBase> TranMapSolarSystemAsync(int id)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<MapSolarSystemBase>().FirstAsync(p => id == p.SolarSystemID);
        }
        ...
        public static async Task<List<StaStationBase>> TranStaStationsAsync(List<int> ids)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<StaStationBase>().Where(p => ids.Contains(p.StationID)).ToList();
            });
        }
        public static async Task<StaStationBase> TranStaStationAsync(int id)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<StaStationBase>().FirstAsync(p => id == p.StationID);
        }
        ...
        public static async Task<List<InvMarketGroupBase>> TranInvMarketGroupsAsync(List<int> ids)
        {
            ...
            {
                SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
                return db.Queryable<InvMarketGroupBase>().Where(p => ids.Contains(p.MarketGroupID)).ToList();
            });
        }
        public static async Task<InvMarketGroupBase> TranInvMarketGroupAsync(int id)
        {
            SqlSugarClient db = new SqlSugarClient(DBModels.Config.ZHDBConnectionConfig);
            return await db.Queryable<InvMarketGroupBase>().FirstAsync(p => id == p.MarketGroupID);
        }
