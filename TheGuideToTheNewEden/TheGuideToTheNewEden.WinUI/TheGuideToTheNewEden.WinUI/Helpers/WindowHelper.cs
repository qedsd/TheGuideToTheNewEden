...
namespace TheGuideToTheNewEden.WinUI.Helpers
{
    public class WindowHelper
    {
        ...
        {
            foreach(var win in _activeWindows.Distinct().ToList())
            {
                try
                {
        ...
        public static void SetForegroundWindow5(IntPtr targetHandle)
        {
            ...
            //Win32.keybd_event(0x12, 0, 0x0001, 0);//Alt键
            //Win32.keybd_event(0x12, 0, 0x0001 | 0x0002, 0);
            //SetForegroundWindow_Click(targetHandle);

            ForegroundHelper.ActivateWindow(targetHandle);
        }
