...
namespace TheGuideToTheNewEden.Core.Models.ChannelIntel
{
    ...
    /// 预警设置
    /// </summary>
    public class ChannelIntelSetting : ObservableObject
    {
        ...
        private ObservableCollection<ChannelIntelSoundSetting> sounds = new ObservableCollection<ChannelIntelSoundSetting>();
        public ObservableCollection<ChannelIntelSoundSetting> Sounds
        {
            get => sounds;
    ...
    public class ChannelIntelSoundSetting : ObservableObject
    {
        private int id;
        public int Id
        {
